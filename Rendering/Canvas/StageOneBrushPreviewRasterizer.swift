...
enum StageOneBrushPreviewRasterizer {
    ...
    private static func makeCompoundStrokePreviewCacheKey(
        ...
        hasher.combine(brush.medium.rawValue)
        hasher.combine(brush.oilPaint.paintLoad)
        hasher.combine(brush.oilPaint.colorSeparation)
        hasher.combine(brush.oilPaint.dryness)
        hasher.combine(brush.oilPaint.bristleSpread)
        hasher.combine(brush.oilPaint.companionColorA)
        hasher.combine(brush.oilPaint.companionColorB)
        ...
        hasher.combine(brush.buildUpOpacityCompensationAmount)
