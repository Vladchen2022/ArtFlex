...
struct WorkspaceViewModelSafetyTests {
    ...
    func oilPaintControlsStayIndependentFromStandardBrushSettings() throws {
        let harness = try BrushEditingBoundaryHarness()
        let mainColor = RGBAColor(red: 0.12, green: 0.54, blue: 0.86, alpha: 1)
        let companionA = RGBAColor(red: 0.84, green: 0.26, blue: 0.12, alpha: 0.4)
        let companionB = RGBAColor(red: 0.18, green: 0.72, blue: 0.38, alpha: 0.7)

        harness.viewModel.setSelectedColor(mainColor)
        ...
        harness.viewModel.setOilCompanionColor(slot: 0, color: companionA)
        harness.viewModel.setOilCompanionColor(slot: 1, color: companionB)
        ...
        #expect(brush.oilPaint.companionColorA == companionA.withAlpha(1))
        #expect(brush.oilPaint.companionColorB == companionB.withAlpha(1))
        #expect(harness.viewModel.workspace.toolSession.selectedColor == mainColor)
