...
当前工作分支另有 [绘画核心升级候选实现](Docs/PAINTING_CORE_UPGRADE_20260908.md)：增量恢复、原生稀疏图层、方案共享底稿、保留裁剪像素和 16 位浮点。候选构建号 `20260908.23`，尚未安装／屏幕验收；运行软件仍为 `20260908.22`。不能把下面既往版本的屏幕验收结果算作这次验收。
